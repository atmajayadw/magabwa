...
<html>
    ...
    <body class="font-[Poppins] pb-[83px]">
            ...
            <div class="logo-container flex gap-[30px] items-center">
                ...
                >
                    <button type="submit" class="w-5 h-5 flex shrink-0">
                        <img
                            src="{{
                                asset('assets/images/icons/search-normal.svg')
                            }}"
                            alt="icon"
                        />
                    </button>
            ...
            <div class="flex items-center gap-3">
                ...
                >
                    <div class="w-6 h-6 flex shrink-0">
                        <img
                            src="{{
                                asset('assets/images/icons/favorite-chart.svg')
                            }}"
                            alt="icon"
                        />
                    </div>
        ...
        >
            ...
            <a
                href="{{route('front.category', $item_category->slug)}}"
                class="rounded-full p-[12px_22px] flex gap-[10px] font-semibold transition-all duration-300 border border-[#EEF0F7] hover:ring-2 hover:ring-[#FF6B18]"
            >
                <div class="w-6 h-6 flex shrink-0">
                    <img
                        src="{{Storage::url($item_category->icon)}}"
                        alt="icon"
                    />
                </div>
        ...
        <section
            id="Category-result"
            class="max-w-[1130px] mx-auto flex items-center flex-col gap-[30px] mt-[70px]"
        >
            ...
            <div id="search-cards" class="grid grid-cols-3 gap-[30px]">
                ...
                <a href="{{route('front.details', $news->slug)}}" class="card">
                    ...
                    >
                        <div
                            class="thumbnail-container h-[200px] relative rounded-[20px] overflow-hidden"
                        >
                            <div
            ...
            <div class="flex flex-col gap-3 shrink-0 w-fit">
                <a href="#">
                    ...
                    >
                        <img
                            src="{{
                                asset('assets/images/iklans/bannerWide1.png')
                            }}"
