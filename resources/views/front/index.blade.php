...
<html>
    ...
    <body class="font-[Poppins] pb-[72px]">
        <nav
            id="Navbar"
            class="max-w-[1130px] mx-auto flex justify-between items-center mt-[30px]"
        >
            ...
            <div class="flex items-center gap-3">
                ...
                >
                    <div class="w-6 h-6 flex shrink-0">
                        <img
                            src="assets/images/icons/favorite-chart.svg"
                            alt="icon"
                        />
                    </div>
                    <span>Post Ads</span>
        ...
        <nav
            id="Category"
            class="max-w-[1130px] mx-auto flex justify-center items-center gap-4 mt-[30px]"
        >
        ...
        <section id="Featured" class="mt-[30px]">
            <div class="main-carousel w-full">
                <div
                    class="featured-news-card relative w-full h-[550px] flex shrink-0 overflow-hidden"
                >
                    <img
                        src="assets/images/thumbnails/th-cyclist.png"
                    ...
                    >
                        <div class="flex flex-col gap-[10px]">
                            ...
                            <a
                                ...
                                >Generation Z Prefer Remote Working Than Big
                                Salary</a
                            >
                            <p class="text-white">12 Jun, 2024 • Business</p>
                        </div>
                        <div
                            class="prevNextButtons flex items-center gap-4 mb-[60px]"
                        >
                            <button
        ...
        <section
            id="Up-to-date"
            class="max-w-[1130px] mx-auto flex flex-col gap-[30px] mt-[70px]"
        >
            ...
            <div class="grid grid-cols-3 gap-[30px]">
                    ...
                    >
                        ...
                        <div class="card-info flex flex-col gap-[6px]">
                            <h3 class="font-bold text-lg leading-[27px]">
                                Bersepeda dapat membuat diri menjadi lebih baik
                                lagi
                            </h3>
                ...
                <a href="details.html" class="card-news">
                    ...
                    >
                        ...
                        <div class="card-info flex flex-col gap-[6px]">
                            <h3 class="font-bold text-lg leading-[27px]">
                                Beberapa artis ini merayakan ultah di tengah
                                hutan raya
                            </h3>
                            <p class="text-sm leading-[21px] text-[#A3A6AE]">
                                12 Jun, 2024
                ...
                <a href="details.html" class="card-news">
                    ...
                    >
                        ...
                        >
                            ...
                            <img
                                src="assets/images/thumbnails/th-demonstration.png"
                                class="object-cover w-full h-full"
                                alt="thumbnail"
                            />
                        </div>
                        <div class="card-info flex flex-col gap-[6px]">
                            <h3 class="font-bold text-lg leading-[27px]">
                                Terjadi demo pada ibu kota jakarta membuat macet
                                parah
                            </h3>
                            <p class="text-sm leading-[21px] text-[#A3A6AE]">
                                12 Jun, 2024
        ...
        >
            ...
            <div class="grid grid-cols-6 gap-[30px]">
                <a href="author.html" class="card-authors">
                    ...
                    >
                        <div
                            class="w-[70px] h-[70px] flex shrink-0 rounded-full overflow-hidden"
                        >
                            <img
                                src="assets/images/photos/photo.png"
                                class="object-cover w-full h-full"
                                alt="avatar"
                            />
                        </div>
                ...
                <a href="author.html" class="card-authors">
                    ...
                    >
                        ...
                        >
                            <img
                                src="assets/images/photos/photo3.png"
                                class="object-cover w-full h-full"
                                alt="avatar"
                            />
                        </div>
                ...
                <a href="author.html" class="card-authors">
                    ...
                    >
                        ...
                        >
                            <img
                                src="assets/images/photos/photo4.png"
                                class="object-cover w-full h-full"
                                alt="avatar"
                            />
                        </div>
                ...
                <a href="author.html" class="card-authors">
                    ...
                    >
                        ...
                        >
                            <img
                                src="assets/images/photos/photo5.png"
                                class="object-cover w-full h-full"
                                alt="avatar"
                            />
                        </div>
        ...
        <section
            id="Advertisement"
            class="max-w-[1130px] mx-auto flex justify-center mt-[70px]"
        >
            <div class="flex flex-col gap-3 shrink-0 w-fit">
                <a href="#">
                    <div
                        class="w-[900px] h-[120px] flex shrink-0 border border-[#EEF0F7] rounded-2xl overflow-hidden"
                    >
                        <img
                            src="assets/images/iklans/bannerWide1.png"
                            class="object-cover w-full h-full"
                            alt="ads"
                        />
                    </div>
                ...
                <p
                    class="font-medium text-sm leading-[21px] text-[#A3A6AE] flex gap-1"
                >
                    Our Advertisement
        ...
        >
            ...
            <div class="flex justify-between items-center h-fit">
                ...
                >
                    ...
                    ></div>
                    <div
                        class="card-detail w-full flex items-end p-[30px] relative z-20"
                    >
                        <div class="flex flex-col gap-[10px]">
                            <p class="text-white">Featured</p>
                            <a
                                ...
                                >Rela Tampil Menarik Depan Wanita, Pria Ini Jadi
                                Bahan Bicaraan</a
                            >
                ...
                <div
                    class="h-[424px] w-fit px-5 overflow-y-scroll overflow-x-hidden relative custom-scrollbar"
                >
                    <div class="w-[455px] flex flex-col gap-5 shrink-0">
                        <a href="details.html" class="card py-[2px]">
                            ...
                            >
                                ...
                                >
                                    <img
                                        src="assets/images/thumbnails/th-sunbathe.png"
                                        class="object-cover w-full h-full"
                                        alt="thumbnail"
                                    />
                                </div>
                                <div
                                    class="flex flex-col justify-center-center gap-[6px]"
                                >
                                    <h3
                                        class="font-bold text-lg leading-[27px]"
                                    >
                                        Bikin house party tanpa biaya mahal,
                                        begini tipsnya!
                                    </h3>
                                    <p
                                        class="text-sm leading-[21px] text-[#A3A6AE]"
                                    >
                                        12 Jun, 2024
                                    </p>
                                </div>
                            ...
                            >
                                ...
                                >
                                    <h3
                                        class="font-bold text-lg leading-[27px]"
                                    >
                                        Gaya pakaian pernikahan artis ini
                                        beneran unik
                                    </h3>
                                    <p
                                        class="text-sm leading-[21px] text-[#A3A6AE]"
                            ...
                            >
                                ...
                                >
                                    <h3
                                        class="font-bold text-lg leading-[27px]"
                                    >
                                        Tips bersepeda bareng pasangan baru,
                                        makin seru!
                                    </h3>
                                    <p
                                        class="text-sm leading-[21px] text-[#A3A6AE]"
                    ...
                    <div class="w-[455px] flex flex-col gap-5 shrink-0">
                        <a href="details.html" class="card py-[2px]">
                            ...
                            >
                                ...
                                >
                                    <img
                                        src="assets/images/thumbnails/th-building.png"
                                        class="object-cover w-full h-full"
                                        alt="thumbnail"
                                    />
                                </div>
                                ...
                                >
                                    <h3
                                        class="font-bold text-lg leading-[27px]"
                                    >
                                        Angga telah launching office space
                                        special edition
                                    </h3>
                                    <p
                                        class="text-sm leading-[21px] text-[#A3A6AE]"
                        ...
                        <a href="details.html" class="card py-[2px]">
                            ...
                            >
                                ...
                                >
                                    <img
                                        src="assets/images/thumbnails/th-key.png"
                                        class="object-cover w-full h-full"
                                        alt="thumbnail"
                                    />
                                </div>
                                ...
                                >
                                    <h3
                                        class="font-bold text-lg leading-[27px]"
                                    >
                                        Pembelian rumah saat ini tanpa perlu
                                        down payment
                                    </h3>
                                    <p
                                        class="text-sm leading-[21px] text-[#A3A6AE]"
                            ...
                            >
                                ...
                                >
                                    <h3
                                        class="font-bold text-lg leading-[27px]"
                                    >
                                        Tips trading ala generation Z bikin kita
                                        sukses untung
                                    </h3>
                                    <p
                                        class="text-sm leading-[21px] text-[#A3A6AE]"
        ...
        >
            ...
            <div class="flex justify-between items-center h-fit">
                ...
                >
                    <img
                        src="assets/images/thumbnails/th-bulldozer.png"
                        class="thumbnail absolute w-full h-full object-cover"
                        alt="icon"
                    />
                    <div
                            ...
                            >
                                ...
                                >
                                    <h3
                                        class="font-bold text-lg leading-[27px]"
                                    >
                                        Tersedia lebih dari 10,000 charger di
                                        area kota Bandung
                                    </h3>
                                    <p
                                        class="text-sm leading-[21px] text-[#A3A6AE]"
                            ...
                            >
                                ...
                                >
                                    <h3
                                        class="font-bold text-lg leading-[27px]"
                                    >
                                        Porscha merilis mesin baru bertenaga
                                        5,000 power
                                    </h3>
                                    <p
                                        class="text-sm leading-[21px] text-[#A3A6AE]"
                            ...
                            >
                                ...
                                >
                                    <h3
                                        class="font-bold text-lg leading-[27px]"
                                    >
                                        Tesla memperbarui teknologi self driving
                                        lebih akurat
                                    </h3>
                                    <p
                                        class="text-sm leading-[21px] text-[#A3A6AE]"
