    ...
    <body class="font-[Poppins] pb-[72px]">
        ...
        >
            ...
            <div class="flex justify-between items-center h-fit">
                ...
                >
                    <img
                        src="{{Storage::url($entertainment__featured_articles->thumbnail)}}"
                        class="thumbnail absolute w-full h-full object-cover"
                        alt="icon"
                    />
                    <div
                    ...
                    >
                        <div class="flex flex-col gap-[10px]">
                            <p class="text-white">Featured</p>
                            <a
                                href="{{route('front.details', $entertainment__featured_articles->slug)}}"
                                class="font-bold text-[30px] leading-[36px] text-white hover:underline transition-all duration-300"
                                >{{$entertainment__featured_articles->name}}</a
                            >
                            <p class="text-white">{{$entertainment__featured_articles->created_at->format('M d, Y')}}
                            </p>
                        </div>
                    </div>
                </div>
